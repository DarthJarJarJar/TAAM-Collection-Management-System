...
public class AddItemFragmentView extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    ArrayAdapter<String> categoryAutoCompleteAdapter = new ArrayAdapter<>(requireContext(),
        android.R.layout.simple_spinner_dropdown_item, presenter.getCategories());
    categoryAutoCompleteAdapter.setDropDownViewResource(
        android.R.layout.simple_spinner_dropdown_item);
    autoCompleteCategory.setAdapter(categoryAutoCompleteAdapter);

    ArrayAdapter<String> periodAutoCompleteAdapter = new ArrayAdapter<>(requireContext(),
        android.R.layout.simple_spinner_dropdown_item, presenter.getPeriods());
    periodAutoCompleteAdapter.setDropDownViewResource(
        android.R.layout.simple_spinner_dropdown_item);
