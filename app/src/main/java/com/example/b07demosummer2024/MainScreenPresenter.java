...
public class MainScreenPresenter implements MainScreenPresenterInterface {
  ...
  /**
   * handles clicking of the back page button. move to the previous page if exits and scrolls to
   * top
   */
  void handlePageDown() {
    if (pageNumber > 1) {
  ...
  /**
   * paginates the item list. based on the page number, updates the recycler view of items to only
   * contain the 10 items corresponding to the current page
   */
  void paginateList() {
  ...
  /**
   * makes a page info string of the format "Page <pageNumber> of <maxPages>". "No Items" if there
   * are 0 items in the itemList
   *
