...
public class SearchFragmentModel {
   ...
   */
  public List<Item> filterItems(int lotNumber, String itemName, String category, String period,
      boolean checkCategory, boolean checkPeriod, String keyword) {
    ...
    for (Item item : allItems) {
      ...
      boolean matchesCategory =
          !checkCategory || category.equals("Any") || item.getCategory().equals(category);
      boolean matchesPeriod =
          !checkPeriod || period.equals("Any") || item.getPeriod().equals(period);
